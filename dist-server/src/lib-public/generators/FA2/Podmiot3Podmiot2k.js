...
function generateDaneIdentyfikacyjneTPodmiot3Dto(podmiot2KDto, index) {
    ...
    if ((0, PDF_functions_1.hasValue)(podmiot1.NrEORI) ||
        ...
        result.push(...(0, PDF_functions_1.createHeader)('Dane identyfikacyjne'), (0, PDF_functions_1.createLabelText)('Numer EORI: ', podmiot1.NrEORI), (0, PDF_functions_1.createLabelText)('Rola: ', (0, functions_1.translateMap)(podmiot1.Rola, FA_const_1.FA2RolaPodmiotu3)), (0, PDF_functions_1.createLabelText)('Rola inna: ', podmiot1.OpisRoli), (0, PDF_functions_1.createLabelText)('Udział: ', podmiot1.Udzial, common_enum_1.default.Percentage));
    }
