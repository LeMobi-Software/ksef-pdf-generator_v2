...
function generatePodmiot1Podmiot1K(podmiot1, podmiot1K) {
    ...
    let firstColumn = [];
    let secondColumn = [];
    firstColumn.push((0, PDF_functions_1.createHeader)('Dane identyfikacyjne'), (0, PDF_functions_1.createLabelText)('Numer EORI: ', podmiot1.NrEORI));
    if (podmiot1.DaneIdentyfikacyjne) {
        firstColumn.push(...(0, PodmiotDaneIdentyfikacyjneTPodmiot1Dto_1.generateDaneIdentyfikacyjneTPodmiot1Dto)(podmiot1.DaneIdentyfikacyjne));
    }
    if (podmiot1.DaneKontaktowe) {
        firstColumn.push((0, PodmiotDaneKontaktowe_1.generateDaneKontaktowe)((0, PDF_functions_1.getTable)(podmiot1.DaneKontaktowe)));
    }
