...
function generatePodsumowanieStawekPodatkuVat(faktura) {
    const AnyP13P14_5Diff0 = (0, PDF_functions_1.hasValue)(faktura.Fa?.P_13_1) ||
        ...
        (0, PDF_functions_1.hasValue)(faktura.Fa?.P_13_6_1) ||
        (0, PDF_functions_1.hasValue)(faktura.Fa?.P_13_6_2) ||
        (0, PDF_functions_1.hasValue)(faktura.Fa?.P_13_6_3) ||
        (0, PDF_functions_1.hasValue)(faktura.Fa?.P_13_7) ||
        (0, PDF_functions_1.hasValue)(faktura.Fa?.P_13_8) ||
        (0, PDF_functions_1.hasValue)(faktura.Fa?.P_13_9) ||
        (0, PDF_functions_1.hasValue)(faktura.Fa?.P_13_10) ||
        (0, PDF_functions_1.hasValue)(faktura.Fa?.P_13_11);
...
function getSummaryTaxRate(fa) {
    ...
    if (AnyP13_6_1Diff0) {
        summary.push({
            no,
            net: (0, PDF_functions_1.getNumberRounded)(fa.P_13_6_1).toFixed(2),
            gross: (0, PDF_functions_1.getNumberRounded)(fa.P_13_6_1).toFixed(2),
            tax: '0.00',
            taxPLN: '',
    ...
    if (AnyP13_6_2Diff0) {
        summary.push({
            no,
            net: (0, PDF_functions_1.getNumberRounded)(fa.P_13_6_2).toFixed(2),
            gross: (0, PDF_functions_1.getNumberRounded)(fa.P_13_6_2).toFixed(2),
            tax: '0.00',
            taxPLN: '',
            taxRateString: '0% - wdt',
        });
    ...
    if (AnyP13_6_3Diff0) {
        summary.push({
            no,
            net: (0, PDF_functions_1.getNumberRounded)(fa.P_13_6_3).toFixed(2),
            gross: (0, PDF_functions_1.getNumberRounded)(fa.P_13_6_3).toFixed(2),
            tax: '0.00',
            taxPLN: '',
    ...
    if (AnyP13_8Diff0) {
        summary.push({
            no,
            net: (0, PDF_functions_1.getNumberRounded)(fa.P_13_8).toFixed(2),
            gross: (0, PDF_functions_1.getNumberRounded)(fa.P_13_8).toFixed(2),
            tax: '0.00',
            taxPLN: '',
    ...
    if (AnyP13_9Diff0) {
        summary.push({
            no,
            net: (0, PDF_functions_1.getNumberRounded)(fa.P_13_9).toFixed(2),
            gross: (0, PDF_functions_1.getNumberRounded)(fa.P_13_9).toFixed(2),
            tax: '0.00',
            taxPLN: '',
    ...
    if (AnyP13_10Diff0) {
        summary.push({
            no,
            net: (0, PDF_functions_1.getNumberRounded)(fa.P_13_10).toFixed(2),
            gross: (0, PDF_functions_1.getNumberRounded)(fa.P_13_10).toFixed(2),
            tax: '0.00',
            taxPLN: '',
    ...
    if (AnyP13_11Diff0) {
        summary.push({
            no,
            net: (0, PDF_functions_1.getNumberRounded)(fa.P_13_11).toFixed(2),
            gross: (0, PDF_functions_1.getNumberRounded)(fa.P_13_11).toFixed(2),
            tax: '0.00',
            taxPLN: '',
            taxRateString: 'marża',
        });
