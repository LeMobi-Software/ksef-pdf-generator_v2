...
function generatePodmiot3(podmiot, index) {
    ...
    const column1 = [
        ...
        (0, PDF_functions_1.createLabelText)('Rola: ', (0, functions_1.translateMap)(podmiot.Rola, FARR_const_1.FARRRolaPodmiotu3)),
        (0, PDF_functions_1.createLabelText)('Opis roli: ', podmiot.OpisRoli),
    ];
    const column2 = [];
    if (podmiot.Adres) {
    ...
    if (podmiot.DaneKontaktowe) {
        column2.push((0, PDF_functions_1.formatText)('Dane kontaktowe', [common_enum_1.default.Label, common_enum_1.default.LabelMargin]), ...(0, PodmiotDaneKontaktowe_1.generateDaneKontaktowe)(podmiot.DaneKontaktowe));
    }
