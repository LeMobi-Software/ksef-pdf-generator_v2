...
function generateZamowienie(orderData, zamowienieKorekta, p_15, rodzajFaktury, KodWaluty, P_PMarzy) {
    ...
    const orderTable = (0, PDF_functions_1.getTable)(orderData?.ZamowienieWiersz).map((el, index) => {
        ...
        el.P_12Z = { _text: (0, PDF_functions_1.getTStawkaPodatku)((0, PDF_functions_1.getValue)(el.P_12Z), 3, P_PMarzy) };
        return el;
    });
    ...
    const definedHeader2 = [
        { name: 'UU_IDZ', title: 'Numer umowy / Zamów.', format: common_enum_1.default.Default, width: 'auto' },
        ...
        { name: 'IndeksZ', title: 'Indeks', format: common_enum_1.default.Default, width: 'auto' },
        { name: 'StanPrzedZ', title: 'Stan przed', format: common_enum_1.default.Boolean, width: 'auto' },
    ];
    ...
    if (Number(p_15) > 0 && rodzajFaktury == FA_const_1.TRodzajFaktury.ZAL) {
        opis = {
            stack: (0, PDF_functions_1.createLabelTextArray)([
                { value: 'Kwota zapłaty (zaliczki) dokumentowana fakturą: ', formatTyp: common_enum_1.default.LabelGreater },
            ...
            stack: (0, PDF_functions_1.createLabelTextArray)([
                {
                    ...
                    formatTyp: common_enum_1.default.LabelGreater,
                },
                { value: p_15, formatTyp: common_enum_1.default.CurrencyGreater },
            ]),
            alignment: common_enum_1.Position.RIGHT,
