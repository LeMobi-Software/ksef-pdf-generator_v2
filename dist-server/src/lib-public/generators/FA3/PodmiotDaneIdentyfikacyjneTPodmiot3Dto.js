...
function generateDaneIdentyfikacyjneTPodmiot3Dto(daneIdentyfikacyjne) {
    ...
    else if ((0, PDF_functions_1.hasValue)(daneIdentyfikacyjne.KodUE)) {
        result.push((0, PDF_functions_1.createLabelTextArray)([
            { value: 'Numer VAT-UE: ', formatTyp: common_enum_1.default.Label },
            { value: daneIdentyfikacyjne.KodUE, formatTyp: common_enum_1.default.Default },
            { value: '' },
            { value: daneIdentyfikacyjne.NrVatUE, formatTyp: common_enum_1.default.Default },
        ]));
    }
    else if ((0, PDF_functions_1.hasValue)(daneIdentyfikacyjne.NrID)) {
        result.push((0, PDF_functions_1.createLabelTextArray)([
            { value: 'Identyfikator podatkowy inny: ', formatTyp: common_enum_1.default.Label },
            { value: daneIdentyfikacyjne.KodKraju, formatTyp: common_enum_1.default.Default },
            { value: '' },
            { value: daneIdentyfikacyjne.NrID, formatTyp: common_enum_1.default.Default },
        ]));
    }
