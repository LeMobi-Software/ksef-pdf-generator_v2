...
function generateSzczegoly(faVat) {
    const faWiersze = (0, PDF_functions_1.getTable)(faVat.FaWiersze?.FaWiersz);
    ...
    if ((0, PDF_functions_1.hasValue)(faVat.KodWaluty) && (0, PDF_functions_1.getValue)(faVat.KodWaluty) != 'PLN') {
        if (faVat.Zamowienie?.ZamowienieWiersz?.length) {
            const Common_KursWaluty = (0, PDF_functions_1.getDifferentColumnsValue)('KursWalutyZ', faVat.Zamowienie?.ZamowienieWiersz);
    ...
    const tpLabel2 = [];
    const forColumns = [
        (0, PDF_functions_1.createLabelText)('Numer faktury: ', faVat.P_2),
    ...
    const table = [
        ...
        ...generateFakturaZaliczkowa((0, PDF_functions_1.getTable)(faVat.NrFaZaliczkowej)),
    ];
...
function generateFakturaZaliczkowa(fakturaZaliczkowa) {
    ...
    const tableFakturaZaliczkowa = (0, PDF_functions_1.getContentTable)(fakturaZaliczkowaHeader, fakturaZaliczkowa, '50%', [0, 4, 0, 0]);
