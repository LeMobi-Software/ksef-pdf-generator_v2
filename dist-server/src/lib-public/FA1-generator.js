...
exports.generateFA1 = generateFA1;
...
const Adnotacje_1 = require("./generators/FA1/Adnotacje");
const DodatkoweInformacje_1 = require("./generators/FA1/DodatkoweInformacje");
const Platnosc_1 = require("./generators/FA1/Platnosc");
const Podmioty_1 = require("./generators/FA1/Podmioty");
const PodsumowanieStawekPodatkuVat_1 = require("./generators/FA1/PodsumowanieStawekPodatkuVat");
const Rabat_1 = require("./generators/FA1/Rabat");
const Szczegoly_1 = require("./generators/FA1/Szczegoly");
const WarunkiTransakcji_1 = require("./generators/FA1/WarunkiTransakcji");
const Wiersze_1 = require("./generators/FA1/Wiersze");
const Zamowienie_1 = require("./generators/FA1/Zamowienie");
...
function generateFA1(invoice, additionalData) {
    ...
    const docDefinition = {
        content: [
            ...(0, Naglowek_1.generateNaglowek)(invoice.Fa, additionalData),
            ...
            rabatOrRowsInvoice,
            (0, Zamowienie_1.generateZamowienie)(invoice.Fa?.Zamowienie, invoice_enums_1.ZamowienieKorekta.Order, invoice.Fa?.P_15?._text ?? '', invoice.Fa?.RodzajFaktury?._text ?? '', invoice.Fa?.KodWaluty?._text ?? '', (0, PDF_functions_1.getValue)(invoice.Fa?.Adnotacje?.P_PMarzy)),
            ...
            ...(0, Stopka_1.generateStopka)(additionalData, invoice.Stopka, invoice.Naglowek, invoice.Fa?.WZ),
        ],
