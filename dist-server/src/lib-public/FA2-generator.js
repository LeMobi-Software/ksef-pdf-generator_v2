...
exports.generateFA2 = generateFA2;
...
const Adnotacje_1 = require("./generators/FA2/Adnotacje");
const DodatkoweInformacje_1 = require("./generators/FA2/DodatkoweInformacje");
const Platnosc_1 = require("./generators/FA2/Platnosc");
const Podmioty_1 = require("./generators/FA2/Podmioty");
const PodsumowanieStawekPodatkuVat_1 = require("./generators/FA2/PodsumowanieStawekPodatkuVat");
const Rabat_1 = require("./generators/FA2/Rabat");
const Szczegoly_1 = require("./generators/FA2/Szczegoly");
const WarunkiTransakcji_1 = require("./generators/FA2/WarunkiTransakcji");
const Wiersze_1 = require("./generators/FA2/Wiersze");
const Zamowienie_1 = require("./generators/FA2/Zamowienie");
...
function generateFA2(invoice, additionalData) {
